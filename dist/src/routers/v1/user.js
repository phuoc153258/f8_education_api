...
const authorMiddleWare_1 = __importDefault(require("../../middlewares/auth/authorMiddleWare"));
...
router.route("/:slug").get(authenMiddleWare_1.default.isLogin, user_1.default.get);
router
    .route("/:userId")
    .put((0, express_fileupload_1.default)({ createParentPath: true }), authenMiddleWare_1.default.requireLogin, user_1.default.update);
router
    .route("/")
    .put((0, express_fileupload_1.default)({ createParentPath: true }), authenMiddleWare_1.default.requireLogin, user_1.default.updateCurrentUser)
    .get(authenMiddleWare_1.default.requireLogin, user_1.default.list);
