...
const userController = {
    ...
    get: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const user = yield user_1.userService.get(slug);
            return res.success(base_1.BaseSuccesMessage.SUCCESS, user);
        }
        catch (error) {
            next(error);
        }
    ...
    update: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            return res.success(base_1.BaseSuccesMessage.SUCCESS, updateUser);
        }
        catch (error) {
            next(error);
        }
    ...
    updateCurrentUser: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { user } = req;
            const userResponse = yield user_1.userService.updateCurrentUser(user, req.body, req.files);
