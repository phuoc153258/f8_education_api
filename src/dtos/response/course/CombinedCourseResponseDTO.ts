...
export interface ICombinedCourseResponseDTO {
  _id?: Types.ObjectId;
  title?: String;
  description?: String;
  slug?: String;
...
export default class CombinedCourseResponseDTO {
  ...
  get(): ICombinedCourseResponseDTO {
    const request: ICombinedCourseResponseDTO = {
      _id: this._id,
      title: this._title,
  ...
  responseDTO(model: any, user_course: any) {
    if (!model) {
      return null;
    }
